...
@section('content')
    ...
    <article class="container mt-28">
        ...
        @if ($visimisis->isEmpty())
            <p class="text-xneutral-400 text-sm sm:text-base font-montserrat font-semibold mt-4">
                Tidak ada data visi dan misi yang tersedia saat ini.
            </p>
        @else
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-8">
            <div class="space-y-3">
                <h3 class="font-montserrat text-base sm:text-lg font-semibold text-primary-200 text-center">
                    VISI
                </h3>
                <p class="text-lg sm:text-xl font-semibold font-montserrat text-xneutral-200 text-center uppercase">
                    {!! $visi ?? 'Visi tidak tersedia' !!}
                </p>
            </div>
            <div class="space-y-3">
                <h2 class="font-montserrat text-base sm:text-lg font-semibold text-primary-200 text-center">
                    MISI
                </h2>
                <ol
                    class="list-decimal pl-4 font-montserrat font-semibold text-xneutral-200 text-sm sm:text-base text-justify">
                    {!! $misi ?? '<li>Misi tidak tersedia</li>' !!}
                </ol>
            </div>
        </div>

        <div class="grid grid-cols-1 sm:grid-cols-3 mt-10 border border-xneutral-100 rounded-2xl overflow-hidden">
            <div class="p-[30px]">
