                ...
                <div
                    ...
                    <div class="pt-12">
                        <ul class="bg-white list-disc text-nowrap pl-8 p-3 rounded-xl">
                            ...
                            <li><a href="{{ route('sambutan') }}" class="w-full block pl-2 pr-8 py-1">Sambutan Rektor</a></li>
                        ...
                        <div class="bg-white flex gap-4 px-6 py-3 rounded-xl">
                            <div class="px-4 flex-1">
                                ...
                                <ul class="list-disc space-y-1 text-nowrap">
                                    <li>
                                        <a href="#" class="w-full block pl-2 pr-8 py-1">S1 KEPERAWATAN</a>
                                    </li>
                                    <li>
                                        <a href="#" class="w-full block pl-2 pr-8 py-1">S1 KEBIDANAN</a>
                                    </li>
                                    <li>
                                        <a href="#" class="w-full block pl-2 pr-8 py-1">S1 FARMASI</a>
                                    </li>
                                    <li>
                                        <a href="#" class="w-full block pl-2 pr-8 py-1">S1 ADMINISTRASI RUMAH SAKIT</a>
                                    </li>
                                    <li>
                                        <a href="#" class="w-full block pl-2 pr-8 py-1">D3 KEBIDANAN</a>
                                    </li>
                                    <li>
                                        <a href="#" class="w-full block pl-2 pr-8 py-1">D3 FISIOTERAPI</a>
                                    </li>
                                    <li>
                                        <a href="#" class="w-full block pl-2 pr-8 py-1">D3 FARMASI</a>
                                    </li>
                                </ul>
                            </div>
                            <div class="px-4 flex-1">
                                ...
                                <ul class="list-disc space-y-1 text-nowrap">
                                    <li>
                                        <a href="#" class="w-full block pl-2 pr-8 py-1">S1 MANAJEMEN</a>
                                    </li>
                                    <li>
                                        <a href="#" class="w-full block pl-2 pr-8 py-1">S1 AKUNTANSI</a>
                                    </li>
                                    <li>
                                        <a href="#" class="w-full block pl-2 pr-8 py-1">S1 EKONOMI SYARIAH</a>
                                    </li>
                                    <li>
                                        <a href="#" class="w-full block pl-2 pr-8 py-1">S1 KEWIRAUSAHAAN</a>
                                    </li>
                                </ul>
                            </div>
                            <div class="px-4 flex-1">
                                ...
                                <ul class="text-nowrap space-y-1 list-disc">
                                    <li>
                                        <a href="#" class="w-full block pl-2 pr-8 py-1">S1 PENDIDIKAN GURU SD</a>
                                    </li>
                                    <li>
                                        <a href="#" class="w-full block pl-2 pr-8 py-1">S1 BIOLOGI</a>
                                    </li>
                                    <li>
                                        <a href="#" class="w-full block pl-2 pr-8 py-1">S1 FISIKA</a>
                                    </li>
                                    <li>
                                        <a href="#" class="w-full block pl-2 pr-8 py-1">S1 TEKNIK KOMPUTER</a>
                                    </li>
                                    <li>
                                        <a href="#" class="w-full block pl-2 pr-8 py-1">S1 TEKNIK INDUSTRI</a>
                                    </li>
                                    <li>
                                        <a href="#" class="w-full block pl-2 pr-8 py-1">S1 TEKNIK INFORMATIKA</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
