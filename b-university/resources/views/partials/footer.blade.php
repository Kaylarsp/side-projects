    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-12 lg:gap-36 container">
        <div>
            ...
            <div class="flex items-center gap-11">
                <a href="{{ $datafooter->link_instagram ?? 'null' }}" class="w-8 h-8 grid place-content-center rounded-full bg-primary-200">
                    <i class="bi bi-instagram text-lg text-xneutral-0"></i>
                </a>
                <a href="{{ $datafooter->link_youtube ?? 'null' }}" class="w-8 h-8 grid place-content-center rounded-full bg-primary-200">
                    <i class="bi bi-youtube text-lg text-xneutral-0"></i>
                </a>
                <a href="{{ $datafooter->link_linkedin ?? 'null' }}" class="w-8 h-8 grid place-content-center rounded-full bg-primary-200">
                    <i class="bi bi-linkedin text-sm text-xneutral-0"></i>
                </a>
                <a href="{{ $datafooter->link_facebook ?? 'null' }}" class="w-8 h-8 grid place-content-center rounded-full bg-primary-200">
