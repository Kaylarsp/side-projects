...
@section('content')
    ...
    <article class="container mt-28">
        ...
        @if ($lecturers->isEmpty())
            <p class="text-xneutral-400 text-sm sm:text-base font-montserrat font-semibold mt-4">
                Tidak ada data dosen yang tersedia saat ini.
            </p>
        @else
            <div class="mt-10 space-y-11">
                @foreach ($lecturers as $lecturer)
                    <div class="flex flex-col items-center sm:flex-row gap-8 sm:gap-16">
                        <img class="sm:col-span-2" src="{{ asset('storage/' . $lecturer->image) }}"
                            alt="Foto {{ $lecturer->nama }}" />
    ...
    <article class="container mt-[150px]">
        ...
        @if ($admins->isEmpty())
            <p class="text-xneutral-400 text-sm sm:text-base font-montserrat font-semibold mt-4">
                Tidak ada data tendik yang tersedia saat ini.
            </p>
        @else
            <div class="mt-10 space-y-11">
